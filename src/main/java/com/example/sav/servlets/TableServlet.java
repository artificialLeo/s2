...
@WebServlet(name = "TableServlet", value = "/tbl")
public class TableServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<TbItem> result = collectionTbItemDAO.getTable(request, response, tbItem.getTradeMarketMail(), tbItem.getProdName(), tbItem.getMarkName());
